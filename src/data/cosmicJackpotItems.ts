...
export const COSMIC_ITEMS: CosmicItem[] = [
  ...
  { id: 'coin_1', name: '짤랑이 꼬마 동전', description: '매 턴 수익 x1.1배', size: 1, cost: 1, tier: 1, type: 'passive', effectType: 'multiplier', icon: '🪙' },
  { id: 'cash_dog', name: '지폐 뭉치 댕댕이', description: '매 턴 수익 x1.3배', size: 1, cost: 1, tier: 1, type: 'passive', effectType: 'multiplier', icon: '🐶' },
  { id: 'gold_cat', name: '반짝반짝 금괴 냥이', description: '매 턴 수익 x1.5배', size: 1, cost: 1, tier: 1, type: 'passive', effectType: 'multiplier', icon: '🐱' },
  ...
  { id: 'lucky_coin', name: '행운의 짤랑이 동전', description: '매 턴 행운 +2, 수익 x1.1배', size: 1, cost: 1, tier: 1, type: 'luck', effectType: 'luck', icon: '🪙✨' },
  { id: 'clover_tea', name: '따뜻한 클로버 차', description: '매 턴 행운 +5, 수익 x1.2배', size: 1, cost: 1, tier: 1, type: 'luck', effectType: 'luck', icon: '🍵' },
  { id: 'lucky_charm', name: '행운의 부적', description: '해골(💀) 확률 -10%, 행운 +3', size: 1, cost: 1, tier: 1, type: 'luck', effectType: 'luck', icon: '🧧' },
  { id: 'star_fragment', name: '반짝이는 별조각', description: '별(🌟) 등장 확률 +5%, 수익 x1.1배', size: 1, cost: 1, tier: 1, type: 'luck', effectType: 'luck', icon: '✨' },
  ...
  { id: 'golden_pig_statue', name: '황금 돼지 동상', description: '돈(💰) 등장 확률 +15%, 수익 x1.5배', size: 1, cost: 2, tier: 2, type: 'luck', effectType: 'luck', icon: '🐖' },
  ...
  { id: 'hamster_worker', name: '성실한 알바생 햄스터', description: '1, 2턴엔 x1.1배, 마지막 3턴째엔 x3배', size: 1, cost: 2, tier: 2, type: 'passive', effectType: 'multiplier', icon: '🐹' },
  { id: 'lucky_clover', name: '행운의 네잎클로버', description: '매 턴 x1.1배 ~ x2.0배 랜덤 적용', size: 1, cost: 2, tier: 2, type: 'passive', effectType: 'multiplier', icon: '🍀' },
  ...
  { id: 'golden_feather', name: '반짝이는 황금 깃털', description: '콤보(패턴) 발생 시마다 수익 x1.5배', size: 1, cost: 2, tier: 2, type: 'passive', effectType: 'multiplier', icon: '🪶' },
  ...
  { id: 'alien_jelly', name: '외계인 젤리', description: '매 턴 x1.1배, 다른 외계인 젤리 1개당 배수 x2배', size: 1, cost: 3, tier: 3, type: 'passive', effectType: 'multiplier', icon: '👾' },
  ...
  { id: 'meteor_candy', name: '유성 캔디', description: '슬롯머신에서 🌟이 나올 때마다 수익 x2배', size: 1, cost: 4, tier: 4, type: 'passive', effectType: 'multiplier', icon: '🍬' },
  { id: 'golden_egg', name: '황금 알', description: '매 턴 x1.1배, 라운드 클리어 시 소지품(Wallet) x2배 후 파괴됨', size: 1, cost: 3, tier: 3, type: 'passive', effectType: 'global', icon: '🥚' },
  ...
  { id: 'hot_potato', name: '따끈한 군고구마', description: '이번 라운드 동안 최종 수익 x2배', size: 1, cost: 2, tier: 2, type: 'consumable', effectType: 'global', icon: '🍠' },
